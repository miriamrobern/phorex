...
var testMap = {
  ...
  setUp: function() {
    ...
    southeast = new Pop("Southeasterners",south,22,2,2,100,{piety: 100, aggression: 0},{gender:"mixed",age:"mixed"});
    northwest = new Pop("Northwesterners",north,11,1,1,1,{piety: 100, aggression: 0},{gender:"mixed",age:"mixed"});
    northeast = new Pop("Northeasterners",north,50,1,2,50,{piety: 100, aggression: 0},{gender:"mixed",age:"mixed"});
    southwest = new Pop("Southwesterners",south,21,2,1,21,{piety: 100, aggression: 100},{gender:"mixed",age:"mixed"});
